...
> **Target project:** [danielbenevides-ops/md2html-api](https://github.com/danielbenevides-ops/md2html-api) — Free, open-source markdown-to-HTML API (10 free requests, micropayments via Litecoin beyond that). Homepage: https://147.15.103.217.sslip.io/md2html/
...
```
**MD2HTML API** (github: [`danielbenevides-ops/md2html-api` :octocat:](https://github.com/danielbenevides-ops/md2html-api), web: [`147.15.103.217/md2html`](https://147.15.103.217.sslip.io/md2html/)) – Free, open-source REST API that converts Markdown to formatted HTML. 10 free requests; Litecoin micropayments beyond that.
```
...
2. Verify the live API URL (https://147.15.103.217.sslip.io/md2html/) and CORS status — PRs may be rejected if the link is down.
