# Permission-Based Email Draft (Not Sent)

**Use only for a recipient with documented opt-in.**

**Subject:** MD2HTML v1.4.0: Markdown → HTML via one POST
...
Could this help with a docs, CMS, or AI-output pipeline? Reply if you’d like details; reply “stop” to unsubscribe.
